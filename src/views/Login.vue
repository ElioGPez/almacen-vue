    ...
    <div>
             ...
             <div class="row">
                 <div class="col-sm-4 login-box">
                     ...
                     <div class="row">
                         <input required v-model="email" type="text" placeholder="Email / Nombre de Usuario" class="form-control inpt-sm">
                     </div>
                     <div class="row">
                         <input required v-model="password" type="password" placeholder="Contraseña" class="form-control inpt-sm">
                     </div>
                     ...
                     <div class=" submot-row">
                         <div class="btn btn-sm btn-success" @click="login()"><i class="fas fa-paper-plane"></i> Ingresar</div>
                     </div>
                 </div>
             </div>
